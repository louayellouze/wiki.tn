            ...
            <div className="flex p-16">
                <div className="w-full h-full justify-center items-center lg:justify-start lg:items-start gap-10 flex m-auto">
                    <div className="flex-col justify-center items-center lg:justify-start lg:items-start gap-9 flex">
                        <div className="flex-col gap-6 flex lg:justify-start lg:items-start">
                            <img className="w-48 h-16" src="/assets/img/logo-wiki.svg" alt="WIKI Logo" />
                            <div className="flex-col gap-2 flex">
                                <div className="text-wiki-btn text-lg font-bold">Contactez Nous !</div>
                                <div className="text-wiki-btn text-base font-normal">+216 22 414 444</div>
                                <div className="text-wiki-btn text-base font-normal">7 Jours / 7</div>
                                <div className="text-wiki-btn text-base font-normal mt-2">info@wiki.tn</div>
                                <div className="text-wiki-btn text-base font-normal text-wiki-dark">wiki.repair@wiki.tn</div>
                            </div>
                        </div>
                            ...
                            <div className="justify-center items-center gap-9 flex">
                                <div className="w-6 h-6 justify-center items-center flex">
                                    <a href="#" className="w-6 h-6 relative">
                                        <svg className="hover:stroke-wiki stroke-slate-600" width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="w-full justify-center items-center gap-10 lg:gap-32 hidden lg:flex">
                        <div className="flex-col justify-center items-start gap-3 inline-flex">
                            <div className="text-wiki-btn text-lg font-semibold">Nos Services</div>
                            <div className="flex-col justify-center items-start gap-3.5 flex">
                                <div className="justify-center items-center gap-3 inline-flex">
                                    ...
                                    <a href="#" className="text-wiki-btn text-lg font-normal">Wiki Repair</a>
                                </div>
                                <div className="justify-center items-center gap-3 inline-flex">
                                    <div className="w-2.5 h-2.5 bg-wiki/40 rounded-full" />
                                    <a href='#' className="text-wiki-btn text-lg font-normal">Service Entreprise</a>
                                </div>
                                <div className="justify-center items-center gap-3 inline-flex">
                                    <div className="w-2.5 h-2.5 bg-wiki/40 rounded-full" />
                                ...
                                <div className="justify-center items-center gap-3 inline-flex">
                                    <div className="w-2.5 h-2.5 bg-wiki/40 rounded-full" />
                                    <a href='#' className="text-wiki-btn text-lg font-normal">Service Après Vente</a>
                                </div>
                            </div>
                        </div>
                        <div className="flex-col justify-center items-start gap-3 inline-flex">
                            <div className="text-wiki-btn text-lg font-semibold">Assistance</div>
                            <div className="flex-col justify-center items-start gap-3.5 flex">
                                <div className="justify-center items-center gap-3 inline-flex">
                                    <div className="w-2.5 h-2.5 bg-wiki/40 rounded-full" />
                                ...
                                <div className="justify-center items-center gap-3 inline-flex">
                                    <div className="w-2.5 h-2.5 bg-wiki/40 rounded-full" />
                                    <a href='#' className="text-wiki-btn text-lg font-normal">FAQ’s</a>
                                </div>
                                <div className="justify-center items-center gap-3 inline-flex">
                                    <div className="w-2.5 h-2.5 bg-wiki/40 rounded-full" />
                                    <a href='#' className="text-wiki-btn text-lg font-normal">Politique de retour</a>
                                </div>
                                <div className="justify-center items-center gap-3 inline-flex">
                                    <div className="w-2.5 h-2.5 bg-wiki/40 rounded-full" />
                                    <a href='#' className="text-wiki-btn text-lg font-normal">Paiement sécurisé</a>
                                </div>
                            </div>
                        </div>
                        <div className="flex-col justify-center items-start gap-3 inline-flex">
                            <div className="text-wiki-btn text-lg font-semibold">À Propos</div>
                            <div className="flex-col justify-center items-start gap-3.5 flex">
                                <div className="justify-center items-center gap-3 inline-flex">
                                    <div className="w-2.5 h-2.5 bg-wiki/40 rounded-full" />
                                ...
                                <div className="justify-center items-center gap-3 inline-flex">
                                    <div className="w-2.5 h-2.5 bg-wiki/40 rounded-full" />
                                    <a href='#' className="text-wiki-btn text-lg font-normal">Qui sommes-nous</a>
                                </div>
                                <div className="justify-center items-center gap-3 inline-flex">
                                    <div className="w-2.5 h-2.5 bg-wiki/40 rounded-full" />
                                    <a href='#' className="text-wiki-btn text-lg font-normal">Nos Actualités</a>
                                </div>
                                <div className="justify-center items-center gap-3 inline-flex">
                                    <div className="w-2.5 h-2.5 bg-wiki/40 rounded-full" />
                                    <a href='#' className="text-wiki-btn text-lg font-normal">Recrutement</a>
                                </div>
                            </div>
                        </div>
                    </div>
