          ...
          <div className="mt-4">
            ...
            <div className="mx-auto mb-5.5 mt-5 grid max-w-[370px] grid-cols-2 rounded-[5px] border border-stroke py-[9px] shadow-1 dark:border-dark-3 dark:bg-dark-2 dark:shadow-card">
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-dark-3 xsm:flex-row">
                <span className="font-medium text-dark dark:text-white">Role</span>
                <span className="text-body-sm">{data?.role}</span>
              </div>
              <div className="flex flex-col items-center justify-center gap-1 px-4 xsm:flex-row">
                <span className="font-medium text-dark dark:text-white">Email</span>
                <span className="text-body-sm">{data?.email}</span>
              </div>
            </div>

            <div className="mx-auto max-w-[720px] mb-10">
              <h4 className="font-medium text-dark dark:text-white mb-4">
                Coordonnées (Session Connectée)
              </h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left border border-stroke p-5 rounded-lg dark:border-dark-3">
                <div>
                  <p className="text-body-sm text-gray-500 mb-1">Email</p>
                  <p className="font-medium text-dark dark:text-white">{data?.email}</p>
                </div>
                <div>
                  <p className="text-body-sm text-gray-500 mb-1">Téléphone</p>
                  <p className="font-medium text-dark dark:text-white">{data?.phone}</p>
                </div>
                <div className="md:col-span-2">
                  <p className="text-body-sm text-gray-500 mb-1">Adresse</p>
            ...
            <div className="mx-auto max-w-[720px]">
              ...
              <p className="mt-4">
                Bienvenue sur votre profil. Voici les informations récupérées depuis votre session active.
              </p>
            </div>
