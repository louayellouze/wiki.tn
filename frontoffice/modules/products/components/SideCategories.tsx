    ...
    return (
        <div className='w-[300px]'>
            <div className="flex justify-between mb-3">
                <div className="text-wiki-btn font-semibold">Categories</div>
                <a href="#" className="text-wiki-btn hover:text-wiki text-sm">Reset</a>
            </div>
            <div className="flex justify-between items-center mb-3">
                <label className="flex items-center space-x-2">
                    <input id='allCategories' type="checkbox" className="h-6 w-6 rounded-md bg-slate-400 checked:bg-wiki-btn focus:ring-0"
                        checked={checked}
                        onChange={handleChange} />
                    <label htmlFor='allCategories' className='ml-0 text-gray-800'>All Categories</label>
                </label>
                <div className="text-wiki-btn">10</div>
            </div>
            {CATEGORIES.map((category, index) => (
                <div key={index} className="flex justify-between items-center mb-3">
                    <label className="flex items-center space-x-2">
                        <input id={category.name} type="checkbox" className="h-6 w-6 rounded-md bg-slate-400 checked:bg-wiki-btn focus:ring-0"
            ...
            <div className="flex justify-between items-center mb-3">
                <label className="flex items-center space-x-2">
                    <input id='other' type="checkbox" className="h-6 w-6 rounded-md bg-slate-400 checked:bg-wiki-btn focus:ring-0"
