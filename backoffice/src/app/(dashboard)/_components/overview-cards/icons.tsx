...
export function Repairs(props: SVGPropsType) {
  return (
    <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
      <circle cx={29} cy={29} r={29} fill="#3FD97F" />
      <path
        d="M37.333 34.667v-2.667a2.667 2.667 0 00-2.666-2.667h-5.334v-5.333a2.667 2.667 0 00-2.666-2.667h-2.667v2.667a2.667 2.667 0 002.667 2.667h2.667v5.333h-5.334a2.667 2.667 0 00-2.667 2.667v2.667h2.667a2.667 2.667 0 002.667-2.667v-2.667h5.334v5.333a2.667 2.667 0 002.666 2.667h2.667v-2.667a2.667 2.667 0 00-2.667-2.667h-2.667v-5.333h5.334a2.667 2.667 0 002.666 2.667v2.667h2.667z"
        fill="#fff"
      />
    </svg>
  );
...
export function Payments(props: SVGPropsType) {
  return (
    <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
      <circle cx={29} cy={29} r={29} fill="#FF55E5" />
      <path
        d="M39 24.5H19c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h20c1.1 0 2-.9 2-2v-10c0-1.1-.9-2-2-2zm-1 10H20v-4h18v4zm0-6H20v-2h18v2z"
        fill="#fff"
      />
    </svg>
  );
