    ...
    return (
        <>
            <div className="flex justify-between mb-3">
                <div className="text-wiki-btn font-semibold">Size</div>
            </div>
            <div className="flex justify-between mb-3">
            ...
            {SIZE.map((size, index) => (
                <div key={index} className="flex justify-between items-center mb-3">
                    <label className="flex items-center space-x-2">
                        <input id={size.name} type="checkbox" className="h-6 w-6 rounded-md bg-slate-300 checked:bg-wiki-btn focus:ring-0"
                        // checked={}
                        // onChange={} 
                        />
