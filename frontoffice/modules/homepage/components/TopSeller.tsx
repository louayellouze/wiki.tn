...
const TopSeller = () => {
    return (
        <div className="container mx-auto px-2 md:px-4 py-4 md:py-8">
            <div className="flex flex-col lg:flex-row justify-center items-center gap-4 md:gap-6 mb-5">
                {/* Main featured product */}
                <Card className="w-full lg:w-2/3 min-h-[400px] md:min-h-[500px] justify-center items-center gap-6 md:gap-10 flex flex-col md:flex-row relative p-4 md:p-6">
                    <img className="w-full md:w-1/2 max-h-64 md:max-h-full object-contain rounded-2xl" src="/assets/img/jbl-bar.png" alt="JBL Bar" />

                    <div className="absolute bottom-4 md:hidden">
                        <DotSlide count={1} />
                    </div>

                    <div className="flex-col justify-center items-start gap-6 md:gap-9 flex w-full md:w-1/2">
                        <div className="flex-col justify-center items-start gap-3 md:gap-4 flex">
                            <div className="text-wiki-btn text-base md:text-xl font-semibold">JBL bar 2.1 deep bass</div>
                        ...
                        <div className="flex justify-center items-center gap-2 md:gap-3 flex-wrap">
                            <button className="w-16 h-16 md:w-20 md:h-20 bg-wiki-light/20 rounded-full flex justify-center items-center hover:bg-wiki-light/30">
                                <div className="text-wiki-dark text-xl md:text-2xl font-bold">57</div>
                            </button>
                            <button className="w-16 h-16 md:w-20 md:h-20 bg-wiki-light/20 rounded-full flex justify-center items-center hover:bg-wiki-light/30">
                                <div className="text-wiki-dark text-xl md:text-2xl font-bold">11</div>
                            </button>
                            <button className="w-16 h-16 md:w-20 md:h-20 bg-wiki-light/20 rounded-full flex justify-center items-center hover:bg-wiki-light/30">
                                <div className="text-wiki-dark text-xl md:text-2xl font-bold">33</div>
                            </button>
                            <button className="w-16 h-16 md:w-20 md:h-20 bg-wiki-light/20 rounded-full flex justify-center items-center hover:bg-wiki-light/30">
                                <div className="text-wiki-dark text-xl md:text-2xl font-bold">59</div>
                            </button>
                        </div>

                        <div className="flex flex-col md:flex-row justify-center items-center gap-3 md:gap-5 w-full">
                            <Button className="w-full md:w-56 h-12 md:h-14 pl-4 md:pl-6 flex justify-between items-center bg-wiki-btn hover:bg-emerald-950 text-white text-sm md:text-base font-semibold">
                                Add to cart
                                <div className="w-8 h-8 bg-wiki rounded-full flex justify-center items-center mr-2 md:mr-4">
                            ...
                            <Button className="w-12 h-12 md:w-16 md:h-14 bg-wiki/20 flex justify-center items-center hover:bg-wiki/40">
                    ...
                    <div className="hidden md:flex absolute bottom-10">
                        <DotSlide count={1} />
                    </div>
                </Card>

                {/* Side products */}
                <div className="flex flex-col gap-4 md:gap-5 w-full lg:w-1/3">
                    <div className="w-full rounded-2xl border border-zinc-400 flex justify-center items-center gap-4 p-4 cursor-pointer hover:bg-slate-100">
                        <img className="w-32 md:w-40 h-24 md:h-32 object-cover rounded-2xl" src="https://source.unsplash.com/288x176?gaming" alt="Gaming" />
                        <div className="flex-col justify-center items-start gap-2 md:gap-4 flex">
                            <div className="text-wiki-btn text-sm md:text-lg font-medium">Play game</div>
                            <div className="text-neutral-600 text-sm md:text-lg font-semibold">$11,70</div>
                            <Star count={5} />
                        </div>
                    </div>
                    <div className="w-full rounded-2xl border border-zinc-400 flex justify-center items-center gap-4 p-4 cursor-pointer hover:bg-slate-100">
                        <img className="w-32 md:w-40 h-24 md:h-32 object-cover rounded-2xl" src="https://source.unsplash.com/288x176?laptop" alt="Laptop" />
                        <div className="flex-col justify-center items-start gap-2 md:gap-4 flex">
                            <div className="text-wiki-btn text-sm md:text-lg font-medium">Play game</div>
                            <div className="text-neutral-600 text-sm md:text-lg font-semibold">$11,70</div>
                            <Star count={5} />
