...
const SignUp = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Validation adresse (min 5 caract)
        ...
        try {
            ...
            // Priority to backend error message
            const msg = err.response?.data?.error || err.response?.data?.message || "Échec de l'inscription. Veuillez réessayer.";
            setError(msg);
        } finally {
            setLoading(false);
        }
