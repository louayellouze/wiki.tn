...
const HeaderTop = () => {
    return (
        <>
            {/* Barre mobile compacte — numéro + suivi commande */}
            <div className="bg-slate-900 border-b border-white/5 lg:hidden">
                <div className="container mx-auto h-8 flex justify-between items-center px-4">
                    <a href="tel:22414444" className="flex items-center gap-1.5 text-wiki text-xs font-bold">
                        <Phone size={11} />
                        <span>22 414 444</span>
                    </a>
                    <Link href="/track-order" className="flex items-center gap-1 text-slate-400 text-xs hover:text-white transition-colors">
