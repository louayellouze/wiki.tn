    ...
    return (
        <>
            <div className="flex justify-between mb-3">
                <div className="text-wiki-btn font-semibold">Avaliability</div>
            </div>
            <div className="flex justify-between mb-3">
            ...
            <div className="flex justify-between items-center mb-3">
                <label className="flex items-center space-x-2">
                    <input id='ins' type="checkbox" className="h-6 w-6 rounded-md bg-slate-300 checked:bg-wiki-btn focus:ring-0"
                    // checked={}
                    // onChange={} 
                    />
            ...
            <div className="flex justify-between items-center mb-3">
                ...
                <div className="text-wiki-btn">0</div>
            </div>
        </>
    )
}
